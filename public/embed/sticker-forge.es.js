...
var nA = 1e3, oi = 1001, rA = 1002, Dt = 1003, Ha = 1004, ka = 1005, St = 1006, Ga = 1007, pr = 1008, Mi = 1009, Wa = 1010, Xa = 1011, $s = 1012, Ya = 1013, bi = 1014, mr = 1015, Ii = 1016, ea = 1017, ta = 1018, ia = 1020, qa = 35902, Ka = 35899, Ja = 1021, Za = 1022, Sn = 1023, Cn = 1026, na = 1027, ja = 1028, ra = 1029, cr = 1030, Aa = 1031, sa = 1033, $a = 33776, eo = 33777, to = 33778, io = 33779, no = 35840, ro = 35841, Ao = 35842, so = 35843, ao = 36196, oo = 37492, lo = 37496, co = 37488, ho = 37489, uo = 37490, fo = 37491, po = 37808, mo = 37809, go = 37810, vo = 37811, wo = 37812, Eo = 37813, Mo = 37814, Po = 37815, _o = 37816, Do = 37817, xo = 37818, So = 37819, Co = 37820, yo = 37821, To = 36492, Bo = 36494, bo = 36495, Io = 36283, Ro = 36284, Lo = 36285, Uo = 36286, hr = 2300, AA = 2301, Pr = 2302, CA = 2303, yA = 2400, TA = 2401, BA = 2402, No = 3200;
...
var zt = {
  ...
  ceilPowerOfTwo: il,
  floorPowerOfTwo: nl,
  setQuaternionFromProperEuler: rl,
  normalize: Mt,
  denormalize: Zi
};
Js = Symbol.iterator;
...
var Oi = /* @__PURE__ */ new Q(), Ht = /* @__PURE__ */ new at(), hl = /* @__PURE__ */ new Q(0, 0, 0), ul = /* @__PURE__ */ new Q(1, 1, 1), fi = /* @__PURE__ */ new Q(), Fn = /* @__PURE__ */ new Q(), Ct = /* @__PURE__ */ new Q(), FA = /* @__PURE__ */ new at(), QA = /* @__PURE__ */ new Li(), Tn = class ca {
...
var ha = class {
...
}, fl = 0, OA = /* @__PURE__ */ new Q(), Vi = /* @__PURE__ */ new Li(), ti = /* @__PURE__ */ new at(), Qn = /* @__PURE__ */ new Q(), cn = /* @__PURE__ */ new Q(), dl = /* @__PURE__ */ new Q(), pl = /* @__PURE__ */ new Li(), VA = /* @__PURE__ */ new Q(1, 0, 0), zA = /* @__PURE__ */ new Q(0, 1, 0), HA = /* @__PURE__ */ new Q(0, 0, 1), kA = { type: "added" }, ml = { type: "removed" }, zi = {
  type: "childadded",
  child: null
}, yr = {
  type: "childremoved",
  child: null
}, Rt = class or extends Ri {
  constructor() {
    super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: fl++ }), this.uuid = an(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = or.DEFAULT_UP.clone();
  ...
  remove(t) {
    ...
    return i !== -1 && (t.parent = null, this.children.splice(i, 1), t.dispatchEvent(ml), yr.child = t, this.dispatchEvent(yr), yr.child = null), this;
  }
  removeFromParent() {
    const t = this.parent;
  ...
  getWorldQuaternion(t) {
    return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(cn, t, dl), t;
  }
  getWorldScale(t) {
    return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(cn, pl, t), t;
  }
  getWorldDirection(t) {
...
var On = class extends Rt {
  ...
  update(e, t, i) {
    ...
    if (e && t.session.visibilityState !== "visible-blurred") {
      ...
      s !== null && (n = t.getPose(e.targetRaySpace, i), n === null && r !== null && (n = r), n !== null && (s.matrix.fromArray(n.transform.matrix), s.matrix.decompose(s.position, s.rotation, s.scale), s.matrixWorldNeedsUpdate = !0, n.linearVelocity ? (s.hasLinearVelocity = !0, s.linearVelocity.copy(n.linearVelocity)) : s.hasLinearVelocity = !1, n.angularVelocity ? (s.hasAngularVelocity = !0, s.angularVelocity.copy(n.angularVelocity)) : s.hasAngularVelocity = !1, this.dispatchEvent(gl)));
    }
...
var vl = class extends Rt {
...
}, kt = /* @__PURE__ */ new Q(), ii = /* @__PURE__ */ new Q(), br = /* @__PURE__ */ new Q(), ni = /* @__PURE__ */ new Q(), Hi = /* @__PURE__ */ new Q(), ki = /* @__PURE__ */ new Q(), GA = /* @__PURE__ */ new Q(), Ir = /* @__PURE__ */ new Q(), Rr = /* @__PURE__ */ new Q(), Lr = /* @__PURE__ */ new Q(), Ur = /* @__PURE__ */ new At(), Nr = /* @__PURE__ */ new At(), Fr = /* @__PURE__ */ new At(), hn = class ji {
  ...
  /* @__PURE__ */ new Q(),
  /* @__PURE__ */ new Q()
], Gt = /* @__PURE__ */ new Q(), zn = /* @__PURE__ */ new Bn(), Gi = /* @__PURE__ */ new Q(), Wi = /* @__PURE__ */ new Q(), Xi = /* @__PURE__ */ new Q(), pi = /* @__PURE__ */ new Q(), mi = /* @__PURE__ */ new Q(), _i = /* @__PURE__ */ new Q(), un = /* @__PURE__ */ new Q(), Hn = /* @__PURE__ */ new Q(), kn = /* @__PURE__ */ new Q(), Di = /* @__PURE__ */ new Q();
...
var ot = /* @__PURE__ */ new Q(), Gn = /* @__PURE__ */ new Re(), wl = 0, jt = class extends Ri {
  constructor(e, t, i = !1) {
    if (super(), Array.isArray(e)) throw new TypeError("THREE.BufferAttribute: array should be a Typed Array.");
    this.isBufferAttribute = !0, Object.defineProperty(this, "id", { value: wl++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e !== void 0 ? e.length / t : 0, this.normalized = i, this.usage = Fo, this.updateRanges = [], this.gpuType = mr, this.version = 0;
  }
  onUploadCallback() {
  }
  set needsUpdate(e) {
...
}, El = /* @__PURE__ */ new Bn(), fn = /* @__PURE__ */ new Q(), Or = /* @__PURE__ */ new Q(), hA = class {
  ...
  setFromPoints(e, t) {
    const i = this.center;
    t !== void 0 ? i.copy(t) : El.setFromPoints(e).getCenter(i);
    let n = 0;
...
}, Ml = 0, Ft = /* @__PURE__ */ new at(), Vr = /* @__PURE__ */ new Rt(), Yi = /* @__PURE__ */ new Q(), yt = /* @__PURE__ */ new Bn(), dn = /* @__PURE__ */ new Bn(), dt = /* @__PURE__ */ new Q(), Ui = class pa extends Ri {
  constructor() {
    super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: Ml++ }), this.uuid = an(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.indirectOffset = 0, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
      start: 0,
      count: 1 / 0
  ...
  setIndex(t) {
    return Array.isArray(t) ? this.index = new (Qo(t) ? da : fa)(t, 1) : this.index = t, this;
  }
  setIndirect(t, i = 0) {
  ...
  constructor() {
    super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: Pl++ }), this.uuid = an(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new ze(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = _r, this.stencilZFail = _r, this.stencilZPass = _r, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
  }
  get alphaTest() {
...
}, Ai = /* @__PURE__ */ new Q(), zr = /* @__PURE__ */ new Q(), Wn = /* @__PURE__ */ new Q(), gi = /* @__PURE__ */ new Q(), Hr = /* @__PURE__ */ new Q(), Xn = /* @__PURE__ */ new Q(), kr = /* @__PURE__ */ new Q(), _l = class {
...
}, WA = /* @__PURE__ */ new at(), xi = /* @__PURE__ */ new _l(), Yn = /* @__PURE__ */ new hA(), XA = /* @__PURE__ */ new Q(), qn = /* @__PURE__ */ new Q(), Kn = /* @__PURE__ */ new Q(), Jn = /* @__PURE__ */ new Q(), Gr = /* @__PURE__ */ new Q(), Zn = /* @__PURE__ */ new Q(), YA = /* @__PURE__ */ new Q(), jn = /* @__PURE__ */ new Q(), Qt = class extends Rt {
...
function $n(e, t, i, n, r, A, s, a, l, o) {
  ...
  const c = Dl(e, t, i, n, qn, Kn, Jn, YA);
  if (c) {
    const u = new Q();
...
var xl = class extends Ot {
...
}, Wr = /* @__PURE__ */ new Q(), Sl = /* @__PURE__ */ new Q(), Cl = /* @__PURE__ */ new Ie(), Ci = class {
  ...
  setFromCoplanarPoints(e, t, i) {
    const n = Wr.subVectors(i, t).cross(Sl.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const i = t || Cl.getNormalMatrix(e), n = this.coplanarPoint(Wr).applyMatrix4(e), r = this.normal.applyMatrix3(i).normalize();
...
}, Si = /* @__PURE__ */ new hA(), yl = /* @__PURE__ */ new Re(0.5, 0.5), er = /* @__PURE__ */ new Q(), uA = class {
  ...
  intersectsSprite(e) {
    return Si.center.set(0, 0, 0), Si.radius = 0.7071067811865476 + yl.distanceTo(e.center), Si.applyMatrix4(e.matrixWorld), this.intersectsSphere(Si);
  }
  intersectsSphere(e) {
...
var Pa = {
  ...
  constructor(e) {
    super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Rl, this.fragmentShader = Ll, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
      clipCullDistance: !1,
      multiDraw: !1
  ...
  constructor(e) {
    super(), this.isMeshDepthMaterial = !0, this.type = "MeshDepthMaterial", this.depthPacking = No, this.map = null, this.alphaMap = null, this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.wireframe = !1, this.wireframeLinewidth = 1, this.setValues(e);
  }
  copy(e) {
...
var In = class {
  ...
  InterpolantFactoryMethodBezier(e) {
    const t = new zl(this.times, this.values, this.getValueSize(), e);
...
Wl.prototype.ValueTypeName = "vector";
var Xl = class {
  constructor(e, t, i) {
    const n = this;
    let r = !1, A = 0, s = 0, a;
...
}, Yl = /* @__PURE__ */ new Xl(), ql = class {
  constructor(e) {
    this.manager = e !== void 0 ? e : Yl, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {}, typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", { detail: this }));
  }
  load() {
  }
  loadAsync(e, t) {
...
var Kl = class extends Rt {
...
}, Xr = /* @__PURE__ */ new at(), KA = /* @__PURE__ */ new Q(), JA = /* @__PURE__ */ new Q(), Jl = class {
  constructor(e) {
...
}, ir = /* @__PURE__ */ new Q(), nr = /* @__PURE__ */ new Li(), qt = /* @__PURE__ */ new Q(), Da = class extends Rt {
  constructor() {
  ...
  constructor(e, t) {
    super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(Rt.DEFAULT_UP), this.updateMatrix(), this.target = new Rt(), this.shadow = new Zl();
  }
  dispose() {
...
}, dA = "\\[\\]\\.:\\/", tc = new RegExp("[" + dA + "]", "g"), pA = "[^" + dA + "]", ic = "[^" + dA.replace("\\.", "") + "]", nc = /* @__PURE__ */ /((?:WC+[\/:])*)/.source.replace("WC", pA), rc = /* @__PURE__ */ /(WCOD+)?/.source.replace("WCOD", ic), Ac = /* @__PURE__ */ /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", pA), sc = /* @__PURE__ */ /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", pA), ac = new RegExp("^" + nc + rc + Ac + sc + "$"), oc = [
  "material",
  "materials",
  "bones",
  "map"
  ...
  static parseTrackName(t) {
    ...
    if (r !== void 0 && r !== -1) {
      ...
      oc.indexOf(A) !== -1 && (n.nodeName = n.nodeName.substring(0, r), n.objectName = A);
    }
...
var rr = {
  ...
  b: 0,
  g: 0
}, fc = /* @__PURE__ */ new at(), Sa = /* @__PURE__ */ new Ie();
Sa.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function dc(e, t, i, n, r, A) {
  const s = new ze(0);
  ...
  function E(S, x) {
    const P = p(x);
    P && (P.isCubeTexture || P.mapping === 306) ? (o === void 0 && (o = new Qt(new fA(1, 1, 1), new It({
...
var wi = 4, es = [
  ...
  0.526,
  0.582
], yi = 20, wc = 256, pn = /* @__PURE__ */ new gr(), ts = /* @__PURE__ */ new ze(), Yr = null, qr = 0, Kr = 0, Jr = !1, Ec = /* @__PURE__ */ new Q(), is = class {
  constructor(e) {
    this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
  }
  fromScene(e, t = 0, i = 0.1, n = 100, r = {}) {
    const { size: A = 256, position: s = Ec } = r;
  ...
  _allocateTargets() {
    ...
    if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
      ...
      ({ lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas } = Mc(r)), this._blurMaterial = _c(r, e, t), this._ggxMaterial = Pc(r, e, t);
    }
    return n;
  }
  _compileMaterial(e) {
  ...
  _sceneToCubeUV(e, t, i, n, r) {
    ...
    l.getClearColor(ts), l.toneMapping = 0, l.autoClear = !1, l.state.buffers.depth.getReversed() && (l.setRenderTarget(n), l.clearDepth(), l.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Qt(new fA(), new ma({
...
function Mc(e) {
  ...
  for (let s = 0; s < A; s++) {
    ...
    const D = new Ui();
    D.setAttribute("position", new jt(S, E)), D.setAttribute("uv", new jt(x, d)), D.setAttribute("faceIndex", new jt(P, f)), n.push(new Qt(D, null)), r > wi && r--;
  }
  return {
    lodMeshes: n,
    sizeLods: t,
...
var Ca = class extends Zt {
  ...
  fromEquirectangularTexture(e, t) {
    ...
    return t.minFilter === 1008 && (t.minFilter = St), new $l(1, 10, this).update(e, A), t.minFilter = s, A.geometry.dispose(), A.material.dispose(), this;
  }
  clear(e, t = !0, i = !0, n = !0) {
...
var ya = /* @__PURE__ */ new Ot(), aA = /* @__PURE__ */ new An(1, 1), Ta = /* @__PURE__ */ new oa(), Ba = /* @__PURE__ */ new cl(), ba = /* @__PURE__ */ new ga(), ss = [], as = [], os = new Float32Array(16), ls = new Float32Array(9), cs = new Float32Array(4);
function on(e, t, i) {
  const n = e[0];
  if (n <= 0 || n > 0) return e;
  const r = t * i;
...
var wh = class {
  ...
  constructor(e, t, i) {
    this.id = e, this.addr = i, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = vh(t.type);
  }
}, Mh = class {
  constructor(e) {
...
function Ph(e, t, i) {
  ...
  for (Zr.lastIndex = 0; ; ) {
    ...
    if (l && (a = a | 0), o === void 0 || o === "[" && s + 2 === r) {
      hs(i, o === void 0 ? new wh(a, e, t) : new Eh(a, e, t));
      break;
    } else {
      let c = i.map[a];
      c === void 0 && (c = new Mh(a), hs(i, c)), i = c;
    }
  }
}
var lr = class {
...
var Lh = /^[ \t]*#include +<([\w\d./]+)>/gm;
function oA(e) {
  return e.replace(Lh, Nh);
}
...
var Fh = /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;
function gs(e) {
  return e.replace(Fh, Qh);
}
function Qh(e, t, i, n) {
  let r = "";
...
function Vh(e) {
  return Oh[e.shadowMapType] || "SHADOWMAP_TYPE_BASIC";
}
var zh = {
...
function Hh(e) {
  return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : zh[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
var kh = { 302: "ENVMAP_MODE_REFRACTION" };
function Gh(e) {
  return e.envMap === !1 ? "ENVMAP_MODE_REFLECTION" : kh[e.envMapMode] || "ENVMAP_MODE_REFLECTION";
}
var Wh = {
...
function Xh(e) {
  return e.envMap === !1 ? "ENVMAP_BLENDING_NONE" : Wh[e.combine] || "ENVMAP_BLENDING_NONE";
}
function Yh(e) {
...
function qh(e, t, i, n) {
  ...
  const l = Vh(i), o = Hh(i), c = Gh(i), u = Xh(i), h = Yh(i), p = bh(i), w = Ih(A), E = r.createProgram();
...
`), f = [
    ...
    i.toneMapping !== 0 ? Th("toneMapping", i.toneMapping) : "",
    i.dithering ? "#define DITHERING" : "",
    i.opaque ? "#define OPAQUE" : "",
    Le.colorspace_pars_fragment,
    Ch("linearToOutputTexel", i.outputColorSpace),
    Bh(),
...
` + ce);
    ...
    r.deleteShader(D), r.deleteShader(C), g = new lr(r, E), _ = Rh(r, E);
  }
  let g;
  ...
  return this.isReady = function() {
    return W === !1 && (W = r.getProgramParameter(E, _h)), W;
  }, this.destroy = function() {
    n.releaseStatesOfProgram(this), r.deleteProgram(E), this.program = void 0;
  }, this.type = i.shaderType, this.name = i.shaderName, this.id = Dh++, this.cacheKey = t, this.usedTimes = 1, this.program = E, this.vertexShader = D, this.fragmentShader = C, this;
}
var Kh = 0, Jh = class {
  constructor() {
  ...
  _getShaderStage(e) {
    ...
    let i = t.get(e);
    return i === void 0 && (i = new Zh(e), t.set(e, i)), i;
  }
}, Zh = class {
  constructor(e) {
...
function $h(e, t, i, n, r, A) {
  const s = new ha(), a = new Jh(), l = /* @__PURE__ */ new Set(), o = [], c = /* @__PURE__ */ new Map(), u = n.logarithmicDepthBuffer;
  let h = n.precision;
  const p = {
  ...
  function P(g, _) {
    let W = c.get(_);
    return W !== void 0 ? ++W.usedTimes : (W = new qh(e, _, g, r), o.push(W), c.set(_, W)), W;
  }
  function D(g) {
    if (--g.usedTimes === 0) {
      const _ = o.indexOf(g);
...
function Es() {
  ...
  function c(h, p, w) {
    i.length > 1 && i.sort(h || tu), n.length > 1 && n.sort(p || ws), r.length > 1 && r.sort(p || ws), w && (i.reverse(), n.reverse(), r.reverse());
  }
  function u() {
...
function fu(e, t, i) {
  let n = new uA();
  const r = new Re(), A = new Re(), s = new At(), a = new Nl(), l = new Fl(), o = {}, c = i.maxTextureSize, u = {
    0: 1,
    1: 0,
    2: 2
  }, h = new It({
    ...
    for (let k = 0, O = C.length; k < O; k++) {
      ...
      if (U.camera._reversedDepth = ee, U.map === null || G === !0) {
        if (U.map !== null && (U.map.depthTexture !== null && (U.map.depthTexture.dispose(), U.map.depthTexture = null), U.map.dispose()), this.type === 3) {
          ...
          X.isPointLight ? (U.map = new Ca(r.x), U.map.depthTexture = new Bl(r.x, bi)) : (U.map = new Zt(r.x, r.y), U.map.depthTexture = new An(r.x, r.y, bi)), U.map.depthTexture.name = X.name + ".shadowMap", U.map.depthTexture.format = Cn, this.type === 1 ? (U.map.depthTexture.compareFunction = ee ? 518 : 515, U.map.depthTexture.minFilter = St, U.map.depthTexture.magFilter = St) : (U.map.depthTexture.compareFunction = null, U.map.depthTexture.minFilter = Dt, U.map.depthTexture.magFilter = Dt);
      ...
      for (let ce = 0; ce < te; ce++) {
        ...
        if (X.isPointLight) {
          ...
          qe !== Ee.far && (Ee.far = qe, Ee.updateProjectionMatrix()), mn.setFromMatrixPosition(X.matrixWorld), Ee.position.copy(mn), jr.copy(Ee.position), jr.add(hu[ce]), Ee.up.copy(uu[ce]), Ee.lookAt(jr), Ee.updateMatrixWorld(), We.makeTranslation(-mn.x, -mn.y, -mn.z), Ps.multiplyMatrices(Ee.projectionMatrix, Ee.matrixWorldInverse), U._frustum.setFromProjectionMatrix(Ps, Ee.coordinateSystem, Ee.reversedDepth);
...
function pu(e, t, i, n, r, A, s) {
  ...
  const Ee = {
    ...
    [Dt]: e.NEAREST,
    [Ha]: e.NEAREST_MIPMAP_NEAREST,
    [ka]: e.NEAREST_MIPMAP_LINEAR,
    [St]: e.LINEAR,
    [Ga]: e.LINEAR_MIPMAP_NEAREST,
...
void main() {
  ...
  constructor(e, t) {
    ...
    const w = typeof XRWebGLBinding < "u", E = new wu(), d = {}, f = t.getContextAttributes();
    let S = null, x = null;
    const P = [], D = [], C = new Re();
    let B = null;
    const g = new Wt();
...
}, Mu = /* @__PURE__ */ new at(), Ia = /* @__PURE__ */ new Ie();
...
function xu() {
  return Kt === null && (Kt = new xl(Du, 16, 16, cr, Ii), Kt.name = "DFG_LUT", Kt.minFilter = St, Kt.magFilter = St, Kt.wrapS = oi, Kt.wrapT = oi, Kt.generateMipmaps = !1, Kt.needsUpdate = !0), Kt;
}
var Su = class {
  constructor(e = {}) {
    const { canvas: t = Vo(), context: i = null, depth: n = !0, stencil: r = !1, alpha: A = !1, antialias: s = !1, premultipliedAlpha: a = !0, preserveDrawingBuffer: l = !1, powerPreference: o = "default", failIfMajorPerformanceCaveat: c = !1, reversedDepthBuffer: u = !1, outputBufferType: h = Mi } = e;
    ...
    function j() {
      Ye = new xc(I), Ye.init(), Z = new mu(I, Ye), tt = new gc(I, Ye, e, Z), M = new du(I, Ye), tt.reversedDepthBuffer && u && M.buffers.depth.setReversed(!0), H = I.createFramebuffer(), G = I.createFramebuffer(), k = I.createFramebuffer(), m = new yc(I), T = new eu(), z = new pu(I, Ye, M, T, tt, Z, m), K = new Dc(_), ne = new uc(I), fe = new pc(I, ne), ae = new Sc(I, ne, m, fe), R = new Bc(I, ae, ne, fe, m), He = new Tc(I, tt, z), Me = new vc(T), ie = new $h(_, K, Ye, tt, fe, Me), de = new Pu(_, T), ve = new iu(), $ = new ou(Ye), be = new dc(_, K, M, R, p, a), Pe = new fu(_, R, tt), ge = new _u(I, m, tt, M), b = new mc(I, Ye, m), q = new Cc(I, Ye, m), m.programs = ie.programs, _.capabilities = tt, _.extensions = Ye, _.properties = T, _.renderLists = ve, _.shadowMap = Pe, _.state = M, _.info = m;
    }
    j(), w !== 1009 && (g = new Ic(w, t.width, t.height, s, n, r));
    const oe = new Eu(_, I);
    ...
    this.renderBufferDirect = function(v, L, V, F, N, Ae) {
      L === null && (L = mt);
      const le = N.isMesh && N.matrixWorld.determinantAffine() < 0, pe = Oa(v, L, V, F, N);
      M.setMaterial(F, le);
      let me = V.index, ye = 1;
      if (F.wireframe === !0) {
      ...
      if (N.isBatchedMesh) if (Ye.get("WEBGL_multi_draw"))
        ...
        const gt = N._multiDrawStarts, we = N._multiDrawCounts, Vt = N._multiDrawCount, Ge = me ? ne.get(me).bytesPerElement : 1, Nt = T.get(F).currentProgram.getUniforms();
        for (let Yt = 0; Yt < Vt; Yt++)
          Nt.setValue(I, "_gl_DrawID", Yt), ke.render(gt[Yt] / Ge, we[Yt]);
      }
    ...
    const Pi = new xa();
    Pi.setAnimationLoop(Fa), typeof self < "u" && Pi.setContext(self), this.setAnimationLoop = function(v) {
    ...
    function Oa(v, L, V, F, N) {
      ...
      const ke = V.morphAttributes.position || V.morphAttributes.normal || V.morphAttributes.color, gt = ke !== void 0 ? ke.length : 0, we = T.get(F), Vt = D.state.lights;
      if ($e === !0 && (pt === !0 || v !== ee)) {
      ...
      if (M.useProgram(Nt.program) && (Yt = !0, hi = !0, Ni = !0), F.id !== J && (J = F.id, hi = !0), we.needsLights) {
        const Ke = Qa(D.state.lightProbeGridArray, N);
      ...
      if ((ui.position !== void 0 || ui.normal !== void 0 || ui.color !== void 0) && He.update(N, V, Nt), (hi || we.receiveShadow !== N.receiveShadow) && (we.receiveShadow = N.receiveShadow, Je.setValue(I, "receiveShadow", N.receiveShadow)), (F.isMeshStandardMaterial || F.isMeshLambertMaterial || F.isMeshPhongMaterial) && F.envMap === null && L.environment !== null && (st.envMapIntensity.value = L.environmentIntensity), st.dfgLUT !== void 0 && (st.dfgLUT.value = xu()), hi) {
        if (Je.setValue(I, "toneMappingExposure", _.toneMappingExposure), we.needsLights && Va(st, Ni), Ae && F.fog === !0 && de.refreshFogUniforms(st, Ae), de.refreshMaterialUniforms(st, F, ue, re, D.state.transmissionRenderTarget[v.id]), we.needsLights && we.lightProbeGrid) {
    ...
    this.getActiveCubeFace = function() {
      ...
      if (v.isWebGLCubeRenderTarget && le !== void 0 && (me = me[le]), me) if (L >= 0 && L <= v.width - F && V >= 0 && V <= v.height - N) {
        ...
        return I.flush(), await zo(I, it, 4), I.bindBuffer(I.PIXEL_PACK_BUFFER, _e), I.getBufferSubData(I.PIXEL_PACK_BUFFER, 0, Ae), I.deleteBuffer(_e), I.deleteSync(it), Ae;
      ...
      const Vt = M.getParameter(I.UNPACK_ROW_LENGTH), Ge = M.getParameter(I.UNPACK_IMAGE_HEIGHT), Nt = M.getParameter(I.UNPACK_SKIP_PIXELS), Yt = M.getParameter(I.UNPACK_SKIP_ROWS), hi = M.getParameter(I.UNPACK_SKIP_IMAGES);
      ...
      M.pixelStorei(I.UNPACK_ROW_LENGTH, Vt), M.pixelStorei(I.UNPACK_IMAGE_HEIGHT, Ge), M.pixelStorei(I.UNPACK_SKIP_PIXELS, Nt), M.pixelStorei(I.UNPACK_SKIP_ROWS, Yt), M.pixelStorei(I.UNPACK_SKIP_IMAGES, hi), Ae === 0 && L.generateMipmaps && I.generateMipmap(we), M.unbindTexture();
...
var Hu = class {
  ...
  update(e, t = Bs(), i = 0) {
    ...
    if (this.lastProgress = n, this.lastUpdateTime = t, n <= $r && (this.liftArmed = !0), n < eA && (this.fullyDetached = !1, this.finishArmed = !0), Math.abs(s) < Nu) {
    ...
    if (s > 0 && w >= Ds) {
      ...
      if (h <= tA && this.smoothedAcceleration > tA && E > 0.2 && t - this.lastAccentTime >= Fu && n < gn) {
  ...
  preload() {
    ...
    bs(this.src, e).then((i) => {
      this.destroyed || t !== this.loadRevision || (this.buffer = i, this.profile = this.useBuiltInProfile ? Ou : zu(i.duration), this.sliceBags = {
        micro: [],
        body: [],
        accent: []
      });
  ...
  preloadReappear() {
    const e = wn();
    !e || !this.enabled || this.destroyed || bs(Lu, e).then((t) => {
  ...
  takeSlice(e) {
    ...
    i.length || (i = Vu(t.length), i.length > 1 && t[i[i.length - 1]]?.key === this.lastSliceKey && ([i[0], i[i.length - 1]] = [i[i.length - 1], i[0]]), this.sliceBags[e] = i);
...
function Yu(e, t, i, n) {
  ...
  return A.clearRect(0, 0, t, i), A.imageSmoothingEnabled = !0, A.imageSmoothingQuality = "high", A.drawImage(e, 0, 0, t, i), Xu(A, t, i, n), r;
}
...
function Ju(e) {
  ...
  const n = Ls(t.getAttribute("width")), r = Ls(t.getAttribute("height"));
...
async function $u(e) {
  const t = Ku(e.svg), i = Ju(t), n = 1740, r = 144, A = i >= 1 ? n : n * i, s = i >= 1 ? n / i : n, a = _t(Math.ceil(A + r * 2), Ei, Bi), l = _t(Math.ceil(s + r * 2), Ei, Bi), o = document.createElement("canvas");
...
async function ef(e) {
  const t = await La(e.src), i = Ua(t), n = _t(t.naturalWidth / t.naturalHeight, 0.15, 8), r = 1740, A = 144, s = n >= 1 ? r : r * n, a = n >= 1 ? r / n : r, l = _t(Math.ceil(s + A * 2), Ei, Bi), o = _t(Math.ceil(a + A * 2), Ei, Bi), c = document.createElement("canvas");
...
function rf(e, t) {
  ...
  if (o) {
    for (let d = 0; d < n; d += 1) Us(a, d * i, 1, l, d * i, 1, i, u, h);
    for (let d = 0; d < i; d += 1) Us(l, d, i, a, d, i, n, u, h);
  }
...
function Af(e, t) {
  ...
  if (r > 0.25) {
    const A = rf(e, r);
    n.drawImage(tf(A, t.color), 0, 0);
  }
  return n.drawImage(e, 0, 0), i;
}
async function Ns(e, t) {
  const i = e.type === "image" ? await ef(e) : {
    canvas: e.type === "text" ? await ju(e) : await $u(e),
    hasTransparency: !0
  }, n = i.canvas, r = Af(n, t), A = r.getContext("2d", { willReadFrequently: !0 });
  if (!A) throw new Error("Canvas 2D is unavailable.");
  ...
  return {
    ...
    alpha: a,
    exteriorAlpha: qu(a, r.width, r.height),
...
}, Fs = 2.55, sf = Math.PI, af = 1.28, Qs = 4e-3, Os = -0.22, of = 0.035, lf = 0.74, cf = 760, hf = 520, Pf = 720, Vs = 720 / 1e3, zs = 0.06, uf = 0.42, ff = 0.32, df = 0.9, pf = "rgb(36, 126, 245)";
function Fe(e, t, i) {
  return Math.min(i, Math.max(t, e));
}
function iA(e, t, i) {
...
var mf = class {
  constructor(e, t = {}) {
    this.camera = new gr(-1, 1, 1, -1, 0.01, 10), this.scene = new vl(), this.peelAudio = new Hu(), this.groundShadowGeometry = new xn(1, 1), this.peelShadowLight = new jl(16777215, 1), this.peelShadowTarget = new Rt(), this.geometry = new xn(1, 1, 2, 2), this.texture = null, this.artwork = null, this.source = Ti, this.requestedSource = Ti, this.sourceRevision = 0, this.sourceRebuildTimer = null, this.destroyed = !1, this.resizeObserver = null, this.viewWidth = 2, this.viewHeight = 2, this.viewportHeightPx = 420, this.renderScale = 1, this.meshWidth = 1.6, this.meshHeight = 0.62, this.pointerId = null, this.grabOrigin = new Re(-0.8, 0), this.grabStart = new Re(), this.grabDirection = new Re(1, 0), this.activeDirection = new Re(1, 0), this.grabExtent = 1.6, this.creaseDepth = 0, this.basePeelRadius = 0.08, this.effectivePeelRadius = 0.08, this.grabProjection = 0, this.springVelocity = 0, this.springActive = !1, this.springTargetDepth = 0, this.dragDetached = !1, this.detachedTension = 0, this.detachedExitActive = !1, this.detachedExitElapsed = 0, this.detachedExitSpin = 0, this.entranceActive = !1, this.entranceElapsed = 0, this.preparedEntrance = null, this.backgroundRemovalEffectActive = !1, this.backgroundRemovalEffectElapsed = 0, this.interactionHintActive = !1, this.interactionHintElapsed = 0, this.entranceAxis = new Re(1, 0), this.frameRequest = 0, this.lastFrameTime = 0, this.state = {
      ...
      if (this.dragDetached) {
        ...
        if (this.grabExtent = this.projectionExtent(this.grabOrigin, this.activeDirection), o)
          ...
          this.creaseDepth - u > this.grabExtent * of || this.springActive && u < this.creaseDepth ? (this.springActive || (this.springActive = !0, this.springVelocity = 0), this.springTargetDepth = u) : (this.springActive = !1, this.springVelocity = 0, this.springTargetDepth = u, this.setCreaseDepth(u));
      ...
      if (this.preparedEntrance) {
        ...
        const l = Fe(this.preparedEntrance.elapsed / ff, 0, 1), o = iA(0, 1, l);
      ...
      if (this.entranceActive && (this.entranceElapsed += A, this.applyEntranceElapsed(this.entranceElapsed) && (this.entranceActive = !1, this.clearEntrancePose(), this.emit("cyclecomplete", { progress: 0 }))), this.interactionHintActive) {
        ...
        const l = Fe(this.interactionHintElapsed / df, 0, 1);
    ...
    }, this.container = e, this.options = En(void 0, t), this.camera.position.z = 3, this.renderer = new Su({
      alpha: !0,
      antialias: !0,
      ...
      uMaterialType: { value: Rs(this.options.material.type) },
  ...
  async setSource(e) {
    ...
    try {
      const i = await Ns(e, this.options.outline);
  ...
  async prepareSource(e, t = {}) {
    ...
    const i = En(this.options, t), n = await Ns(e, i.outline);
    if (this.destroyed) throw new Error("The sticker renderer has been destroyed.");
  ...
  setOptions(e) {
    if (this.destroyed) return;
    const t = this.options.outline, i = this.options.quality, n = this.materialKey();
    this.options = En(this.options, e), this.applyOptionsToRenderer(), this.artwork && this.materialKey() !== n && !e.source && this.refreshMaterialTexture(), e.source && this.setSource(e.source).catch(() => {
  ...
  createArtworkTexture(e, t = this.options.material) {
    const i = Yu(e.canvas, e.width, e.height, t), n = new Tl(i);
  ...
  updateMeshGeometry(e) {
    const t = this.viewHeight / Math.max(1, this.viewportHeightPx), i = Math.min(this.viewWidth * 0.78, cf * t), n = Math.min(this.viewHeight * 0.58, hf * t);
    let r = i, A = r / e;
  ...
  applyOptionsToRenderer() {
    ...
    this.uniforms.uMaxAngle.value = Fe(a, Fs, sf);
    ...
    this.basePeelRadius = c * zt.lerp(0.82, 1.16, Fe(this.options.peel.stiffness, 0, 1)), this.setCreaseDepth(this.creaseDepth), this.uniforms.uShadowColor.value = Bt(this.options.shadow.color, "#191823");
    ...
    this.peelShadowLight.position.set(t.x * f, t.y * f, Math.max(0.8, t.z * f)), this.peelShadowTarget.position.set(0, 0, 0), this.peelShadowLight.shadow.radius = zt.lerp(1, 7, r);
  ...
  setDetachedDragOffset(e, t) {
    const i = zt.degToRad(this.options.tilt), n = Math.cos(i), r = Math.sin(i), A = Fe(Math.hypot(e, t) / Math.max(this.grabExtent * 0.45, 0.12), 0, 1);
  ...
  finishPointerDrag(e) {
    ...
    const i = this.options.peel.release, n = this.springActive ? Math.min(this.state.progress, Fe(this.springTargetDepth / Math.max(this.grabExtent, 1e-3), 0, 1)) : this.state.progress, r = i === "snap" && n >= lf;
...
var vf = typeof HTMLElement > "u" ? class {
} : HTMLElement, ks = class extends vf {
  constructor(...e) {
  ...
  ensureInstance() {
    ...
    const e = Hs(this.pendingOptions, { source: this.pendingSource ?? Ti }), t = this.lifecycleRevision, i = gf(this.mountElement, e);
