var Gs, Ws, Xs, Ys, qs, Ks, Js, Zs, js;
var nA = 1e3, oi = 1001, rA = 1002, Dt = 1003, za = 1004, Ha = 1005, St = 1006, ka = 1007, pr = 1008, Mi = 1009, Ga = 1010, Wa = 1011, $s = 1012, Xa = 1013, bi = 1014, mr = 1015, Ii = 1016, ea = 1017, ta = 1018, ia = 1020, Ya = 35902, qa = 35899, Ka = 1021, Ja = 1022, Sn = 1023, Cn = 1026, na = 1027, Za = 1028, ra = 1029, cr = 1030, Aa = 1031, sa = 1033, ja = 33776, $a = 33777, eo = 33778, to = 33779, io = 35840, no = 35841, ro = 35842, Ao = 35843, so = 36196, ao = 37492, oo = 37496, lo = 37488, co = 37489, ho = 37490, uo = 37491, fo = 37808, po = 37809, mo = 37810, go = 37811, vo = 37812, wo = 37813, Eo = 37814, Mo = 37815, Po = 37816, _o = 37817, Do = 37818, xo = 37819, So = 37820, Co = 37821, yo = 36492, To = 36494, Bo = 36495, bo = 36283, Io = 36284, Ro = 36285, Lo = 36286, hr = 2300, AA = 2301, Pr = 2302, CA = 2303, yA = 2400, TA = 2401, BA = 2402, Uo = 3200;
...
function rl() {
  const e = {
    ...
    convert: function(r, A, s) {
      return this.enabled === !1 || A === s || !A || !s || (this.spaces[A].transfer === "srgb" && (r.r = li(r.r), r.g = li(r.g), r.b = li(r.b)), this.spaces[A].primaries !== this.spaces[s].primaries && (r.applyMatrix3(this.spaces[A].toXYZ), r.applyMatrix3(this.spaces[s].fromXYZ)), this.spaces[s].transfer === "srgb" && (r.r = tn(r.r), r.g = tn(r.g), r.b = tn(r.b))), r;
    },
...
var Qi, Al = class {
  ...
  constructor(e = null) {
    this.isSource = !0, Object.defineProperty(this, "id", { value: sl++ }), this.uuid = an(), this.data = e, this.dataReady = !0, this.version = 0;
  }
  getSize(e) {
    const t = this.data;
...
var ol = class extends Ri {
  ...
  clone() {
    return new la().fromArray(this.elements);
  }
  copy(t) {
  ...
  lookAt(t, i, n) {
    ...
    return Ct.subVectors(t, i), Ct.lengthSq() === 0 && (Ct.z = 1), Ct.normalize(), fi.crossVectors(n, Ct), fi.lengthSq() === 0 && (Math.abs(n.z) === 1 ? Ct.x += 1e-4 : Ct.z += 1e-4, Ct.normalize(), fi.crossVectors(n, Ct)), fi.normalize(), Fn.crossVectors(Ct, fi), r[0] = fi.x, r[4] = Fn.x, r[8] = Ct.x, r[1] = fi.y, r[5] = Fn.y, r[9] = Ct.y, r[2] = fi.z, r[6] = Fn.z, r[10] = Ct.z, this;
  }
  multiply(t) {
...
qs = at;
qs.prototype.isMatrix4 = !0;
var Oi = /* @__PURE__ */ new Q(), zt = /* @__PURE__ */ new at(), cl = /* @__PURE__ */ new Q(0, 0, 0), hl = /* @__PURE__ */ new Q(1, 1, 1), fi = /* @__PURE__ */ new Q(), Fn = /* @__PURE__ */ new Q(), Ct = /* @__PURE__ */ new Q(), FA = /* @__PURE__ */ new at(), QA = /* @__PURE__ */ new Li(), Tn = class ca {
  constructor(t = 0, i = 0, n = 0, r = ca.DEFAULT_ORDER) {
...
var ha = class {
...
}, ul = 0, OA = /* @__PURE__ */ new Q(), Vi = /* @__PURE__ */ new Li(), ti = /* @__PURE__ */ new at(), Qn = /* @__PURE__ */ new Q(), cn = /* @__PURE__ */ new Q(), fl = /* @__PURE__ */ new Q(), dl = /* @__PURE__ */ new Li(), VA = /* @__PURE__ */ new Q(1, 0, 0), zA = /* @__PURE__ */ new Q(0, 1, 0), HA = /* @__PURE__ */ new Q(0, 0, 1), kA = { type: "added" }, pl = { type: "removed" }, zi = {
  type: "childadded",
  child: null
}, yr = {
  type: "childremoved",
  ...
  constructor() {
    super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: ul++ }), this.uuid = an(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = or.DEFAULT_UP.clone();
    ...
    }), this.matrix = new at(), this.matrixWorld = new at(), this.matrixAutoUpdate = or.DEFAULT_MATRIX_AUTO_UPDATE, this.matrixWorldAutoUpdate = or.DEFAULT_MATRIX_WORLD_AUTO_UPDATE, this.matrixWorldNeedsUpdate = !1, this.layers = new ha(), this.visible = !0, this.castShadow = !1, this.receiveShadow = !1, this.frustumCulled = !0, this.renderOrder = 0, this.animations = [], this.customDepthMaterial = void 0, this.customDistanceMaterial = void 0, this.static = !1, this.userData = {}, this.pivot = null;
  }
  onBeforeShadow() {
  }
  onAfterShadow() {
  ...
  lookAt(t, i, n) {
    ...
    const r = this.parent;
    this.updateWorldMatrix(!0, !1), cn.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? ti.lookAt(cn, Qn, this.up) : ti.lookAt(Qn, cn, this.up), this.quaternion.setFromRotationMatrix(ti), r && (ti.extractRotation(r.matrixWorld), Vi.setFromRotationMatrix(ti), this.quaternion.premultiply(Vi.invert()));
  }
  add(t) {
  ...
  attach(t) {
    return this.updateWorldMatrix(!0, !1), ti.copy(this.matrixWorld).invert(), t.parent !== null && (t.parent.updateWorldMatrix(!0, !1), ti.multiply(t.parent.matrixWorld)), t.applyMatrix4(ti), t.removeFromParent(), t.parent = this, this.children.push(t), t.updateWorldMatrix(!1, !0), t.dispatchEvent(kA), zi.child = t, this.dispatchEvent(zi), zi.child = null, this;
  }
  getObjectById(t) {
  ...
  getWorldQuaternion(t) {
    return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(cn, t, fl), t;
  }
  getWorldScale(t) {
    return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(cn, dl, t), t;
  }
  getWorldDirection(t) {
...
var ze = class {
  ...
  setHSL(e, t, i, n = Ve.workingColorSpace) {
    if (e = lA(e, 1), t = Qe(t, 0, 1), i = Qe(i, 0, 1), t === 0) this.r = this.g = this.b = i;
    else {
  ...
  getHex(e = Bt) {
    return Ve.workingToColorSpace(wt.copy(this), e), Math.round(Qe(wt.r * 255, 0, 255)) * 65536 + Math.round(Qe(wt.g * 255, 0, 255)) * 256 + Math.round(Qe(wt.b * 255, 0, 255));
  }
  getHexString(e = Bt) {
    return ("000000" + this.getHex(e).toString(16)).slice(-6);
  }
  getHSL(e, t = Ve.workingColorSpace) {
    Ve.workingToColorSpace(wt.copy(this), t);
  ...
  getRGB(e, t = Ve.workingColorSpace) {
    return Ve.workingToColorSpace(wt.copy(this), t), e.r = wt.r, e.g = wt.g, e.b = wt.b, e;
  }
  getStyle(e = Bt) {
    Ve.workingToColorSpace(wt.copy(this), e);
  ...
  lerpHSL(e, t) {
    ...
    const i = Dn(di.h, Vn.h, t), n = Dn(di.s, Vn.s, t), r = Dn(di.l, Vn.l, t);
...
var gl = class extends It {
...
}, Ht = /* @__PURE__ */ new Q(), ii = /* @__PURE__ */ new Q(), br = /* @__PURE__ */ new Q(), ni = /* @__PURE__ */ new Q(), Hi = /* @__PURE__ */ new Q(), ki = /* @__PURE__ */ new Q(), GA = /* @__PURE__ */ new Q(), Ir = /* @__PURE__ */ new Q(), Rr = /* @__PURE__ */ new Q(), Lr = /* @__PURE__ */ new Q(), Ur = /* @__PURE__ */ new At(), Nr = /* @__PURE__ */ new At(), Fr = /* @__PURE__ */ new At(), hn = class ji {
  ...
  closestPointToPoint(t, i) {
    ...
    const f = 1 / (d + E + h);
    return s = E * f, a = h * f, i.copy(n).addScaledVector(Hi, s).addScaledVector(ki, a);
  }
  equals(t) {
  ...
  intersectsTriangle(e) {
    ...
    this.getCenter(un), Hn.subVectors(this.max, un), Gi.subVectors(e.a, un), Wi.subVectors(e.b, un), Xi.subVectors(e.c, un), pi.subVectors(Wi, Gi), mi.subVectors(Xi, Wi), _i.subVectors(Gi, Xi);
    let t = [
      0,
      -pi.z,
      pi.y,
    ...
    return !Qr(t, Gi, Wi, Xi, Hn) || (t = [
      ...
      0,
      1
    ], !Qr(t, Gi, Wi, Xi, Hn)) ? !1 : (kn.crossVectors(pi, mi), t = [
      kn.x,
      kn.y,
      kn.z
    ], Qr(t, Gi, Wi, Xi, Hn));
  ...
  /* @__PURE__ */ new Q(),
  /* @__PURE__ */ new Q()
], kt = /* @__PURE__ */ new Q(), zn = /* @__PURE__ */ new Bn(), Gi = /* @__PURE__ */ new Q(), Wi = /* @__PURE__ */ new Q(), Xi = /* @__PURE__ */ new Q(), pi = /* @__PURE__ */ new Q(), mi = /* @__PURE__ */ new Q(), _i = /* @__PURE__ */ new Q(), un = /* @__PURE__ */ new Q(), Hn = /* @__PURE__ */ new Q(), kn = /* @__PURE__ */ new Q(), Di = /* @__PURE__ */ new Q();
...
var ot = /* @__PURE__ */ new Q(), Gn = /* @__PURE__ */ new Re(), vl = 0, jt = class extends Ri {
  constructor(e, t, i = !1) {
...
}, wl = /* @__PURE__ */ new Bn(), fn = /* @__PURE__ */ new Q(), Or = /* @__PURE__ */ new Q(), hA = class {
...
}, El = 0, Nt = /* @__PURE__ */ new at(), Vr = /* @__PURE__ */ new It(), Yi = /* @__PURE__ */ new Q(), yt = /* @__PURE__ */ new Bn(), dn = /* @__PURE__ */ new Bn(), dt = /* @__PURE__ */ new Q(), Ui = class pa extends Ri {
  constructor() {
    super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: El++ }), this.uuid = an(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.indirectOffset = 0, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
      start: 0,
      count: 1 / 0
  ...
  setIndex(t) {
    return Array.isArray(t) ? this.index = new (Fo(t) ? da : fa)(t, 1) : this.index = t, this;
  }
  setIndirect(t, i = 0) {
  ...
  toNonIndexed() {
    ...
    const i = new pa(), n = this.index.array, r = this.attributes;
    for (const a in r) {
      const l = r[a], o = t(l, n);
      i.setAttribute(a, o);
    }
...
}, Ml = 0, bn = class extends Ri {
  constructor() {
    super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: Ml++ }), this.uuid = an(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new ze(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = _r, this.stencilZFail = _r, this.stencilZPass = _r, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
  }
  get alphaTest() {
...
}, WA = /* @__PURE__ */ new at(), xi = /* @__PURE__ */ new Pl(), Yn = /* @__PURE__ */ new hA(), XA = /* @__PURE__ */ new Q(), qn = /* @__PURE__ */ new Q(), Kn = /* @__PURE__ */ new Q(), Jn = /* @__PURE__ */ new Q(), Gr = /* @__PURE__ */ new Q(), Zn = /* @__PURE__ */ new Q(), YA = /* @__PURE__ */ new Q(), jn = /* @__PURE__ */ new Q(), Ft = class extends It {
  constructor(e = new Ui(), t = new ma()) {
  ...
  raycast(e, t) {
    ...
    n !== void 0 && (i.boundingSphere === null && i.computeBoundingSphere(), Yn.copy(i.boundingSphere), Yn.applyMatrix4(r), xi.copy(e.ray).recast(e.near), !(Yn.containsPoint(xi.origin) === !1 && (xi.intersectSphere(Yn, XA) === null || xi.origin.distanceToSquared(XA) > (e.far - e.near) ** 2)) && (WA.copy(r).invert(), xi.copy(e.ray).applyMatrix4(WA), !(i.boundingBox !== null && xi.intersectsBox(i.boundingBox) === !1) && this._computeIntersections(e, t, xi)));
  }
...
function $n(e, t, i, n, r, A, s, a, l, o) {
  ...
  const c = _l(e, t, i, n, qn, Kn, Jn, YA);
  if (c) {
    const u = new Q();
...
var Dl = class extends Qt {
...
}, Wr = /* @__PURE__ */ new Q(), xl = /* @__PURE__ */ new Q(), Sl = /* @__PURE__ */ new Ie(), Ci = class {
  ...
  setFromCoplanarPoints(e, t, i) {
    const n = Wr.subVectors(i, t).cross(xl.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const i = t || Sl.getNormalMatrix(e), n = this.coplanarPoint(Wr).applyMatrix4(e), r = this.normal.applyMatrix3(i).normalize();
...
}, Si = /* @__PURE__ */ new hA(), Cl = /* @__PURE__ */ new Re(0.5, 0.5), er = /* @__PURE__ */ new Q(), uA = class {
  ...
  intersectsSprite(e) {
    return Si.center.set(0, 0, 0), Si.radius = 0.7071067811865476 + Cl.distanceTo(e.center), Si.applyMatrix4(e.matrixWorld), this.intersectsSphere(Si);
  }
  intersectsSphere(e) {
  ...
  constructor(t = 1, i = 1, n = 1, r = 1, A = 1, s = 1) {
    ...
    const l = [], o = [], c = [], u = [];
    let h = 0, p = 0;
    w("z", "y", "x", -1, -1, n, i, t, s, A, 0), w("z", "y", "x", 1, -1, n, i, -t, s, A, 1), w("x", "z", "y", 1, 1, t, n, i, r, s, 2), w("x", "z", "y", 1, -1, t, n, -i, r, s, 3), w("x", "y", "z", 1, -1, t, i, n, r, A, 4), w("x", "y", "z", -1, -1, t, i, -n, r, A, 5), this.setIndex(l), this.setAttribute("position", new ci(o, 3)), this.setAttribute("normal", new ci(c, 3)), this.setAttribute("uv", new ci(u, 2));
  ...
  static fromJSON(t) {
    return new wa(t.width, t.height, t.depth, t.widthSegments, t.heightSegments, t.depthSegments);
  }
}, xn = class Ea extends Ui {
  constructor(t = 1, i = 1, n = 1, r = 1) {
    ...
    this.setIndex(p), this.setAttribute("position", new ci(w, 3)), this.setAttribute("normal", new ci(E, 3)), this.setAttribute("uv", new ci(d, 2));
  }
  copy(t) {
    return super.copy(t), this.parameters = Object.assign({}, t.parameters), this;
  }
...
var Pa = {
  ...
  constructor(e) {
    super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Il, this.fragmentShader = Rl, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
      clipCullDistance: !1,
      multiDraw: !1
...
var In = class {
  ...
  InterpolantFactoryMethodBezier(e) {
    const t = new Vl(this.times, this.values, this.getValueSize(), e);
...
var ql = class extends It {
...
}, Xr = /* @__PURE__ */ new at(), KA = /* @__PURE__ */ new Q(), JA = /* @__PURE__ */ new Q(), Kl = class {
  constructor(e) {
...
}, ir = /* @__PURE__ */ new Q(), nr = /* @__PURE__ */ new Li(), qt = /* @__PURE__ */ new Q(), Da = class extends It {
  constructor() {
...
}, vi = /* @__PURE__ */ new Q(), ZA = /* @__PURE__ */ new Re(), jA = /* @__PURE__ */ new Re(), Wt = class extends Da {
  ...
  constructor(e, t) {
    super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(It.DEFAULT_UP), this.updateMatrix(), this.target = new It(), this.shadow = new Jl();
  }
  dispose() {
...
}, qi = -90, Ki = 1, jl = class extends It {
  constructor(e, t, i) {
    super(), this.type = "CubeCamera", this.renderTarget = i, this.coordinateSystem = null, this.activeMipmapLevel = 0;
    const n = new Wt(qi, Ki, e, t);
    n.layers = this.layers, this.add(n);
    const r = new Wt(qi, Ki, e, t);
    r.layers = this.layers, this.add(r);
    const A = new Wt(qi, Ki, e, t);
    A.layers = this.layers, this.add(A);
    const s = new Wt(qi, Ki, e, t);
    s.layers = this.layers, this.add(s);
    const a = new Wt(qi, Ki, e, t);
    a.layers = this.layers, this.add(a);
    const l = new Wt(qi, Ki, e, t);
...
}, dA = "\\[\\]\\.:\\/", ec = new RegExp("[" + dA + "]", "g"), pA = "[^" + dA + "]", tc = "[^" + dA.replace("\\.", "") + "]", ic = /* @__PURE__ */ /((?:WC+[\/:])*)/.source.replace("WC", pA), nc = /* @__PURE__ */ /(WCOD+)?/.source.replace("WCOD", tc), rc = /* @__PURE__ */ /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", pA), Ac = /* @__PURE__ */ /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", pA), sc = new RegExp("^" + ic + nc + rc + Ac + "$"), ac = [
  "material",
  "materials",
  "bones",
  "map"
  ...
  static parseTrackName(t) {
    ...
    if (r !== void 0 && r !== -1) {
      ...
      ac.indexOf(A) !== -1 && (n.nodeName = n.nodeName.substring(0, r), n.objectName = A);
    }
...
Jt.physical = {
  uniforms: /* @__PURE__ */ Pt([Jt.standard.uniforms, {
    clearcoat: { value: 0 },
...
var rr = {
  ...
  b: 0,
  g: 0
}, uc = /* @__PURE__ */ new at(), Sa = /* @__PURE__ */ new Ie();
Sa.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function fc(e, t, i, n, r, A) {
  const s = new ze(0);
  ...
  function E(S, x) {
    ...
    } }), n.update(o)), o.material.uniforms.envMap.value = P, o.material.uniforms.backgroundBlurriness.value = x.backgroundBlurriness, o.material.uniforms.backgroundIntensity.value = x.backgroundIntensity, o.material.uniforms.backgroundRotation.value.setFromMatrix4(uc.makeRotationFromEuler(x.backgroundRotation)).transpose(), P.isCubeTexture && P.isRenderTargetTexture === !1 && o.material.uniforms.backgroundRotation.value.premultiply(Sa), o.material.toneMapped = Ve.getTransfer(P.colorSpace) !== fr, (c !== P || u !== P.version || h !== e.toneMapping) && (o.material.needsUpdate = !0, c = P, u = P.version, h = e.toneMapping), o.layers.enableAll(), S.unshift(o, o.geometry, o.material, 0, 0, null)) : P && P.isTexture && (l === void 0 && (l = new Ft(new xn(2, 2), new bt({
  ...
  function d(S, x) {
    S.getRGB(rr, Ma(e)), i.buffers.color.setClear(rr.r, rr.g, rr.b, x, A);
  }
  function f() {
...
var wi = 4, es = [
  ...
  0.526,
  0.582
], yi = 20, vc = 256, pn = /* @__PURE__ */ new gr(), ts = /* @__PURE__ */ new ze(), Yr = null, qr = 0, Kr = 0, Jr = !1, wc = /* @__PURE__ */ new Q(), is = class {
  constructor(e) {
    this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
  }
  fromScene(e, t = 0, i = 0.1, n = 100, r = {}) {
    const { size: A = 256, position: s = wc } = r;
  ...
  _allocateTargets() {
    ...
    if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
      ...
      ({ lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas } = Ec(r)), this._blurMaterial = Pc(r, e, t), this._ggxMaterial = Mc(r, e, t);
    }
    return n;
  }
  _compileMaterial(e) {
  ...
  _sceneToCubeUV(e, t, i, n, r) {
    ...
    l.getClearColor(ts), l.toneMapping = 0, l.autoClear = !1, l.state.buffers.depth.getReversed() && (l.setRenderTarget(n), l.clearDepth(), l.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Ft(new fA(), new ma({
    ...
    for (let E = 0; E < 6; E++) {
      ...
      Ji(n, d * f, E > 2 ? f : 0, f, f), l.setRenderTarget(n), p && l.render(u, A), l.render(e, A);
    }
  ...
  _applyGGXFilter(e, t, i) {
    ...
    s.material = A;
    const a = A.uniforms, l = i / (this._lodMeshes.length - 1), o = t / (this._lodMeshes.length - 1), c = Math.sqrt(l * l - o * o) * (0 + l * 1.25), { _lodMax: u } = this, h = this._sizeLods[i], p = 3 * h * (i > u - wi ? i - u + wi : 0), w = 4 * (this._cubeSize - h);
  ...
  _halfBlur(e, t, i, n, r, A, s) {
    ...
    Ji(t, 3 * x * (n > S - wi ? n - S + wi : 0), 4 * (this._cubeSize - x), 3 * x, 2 * x), a.setRenderTarget(t), a.render(c, pn);
  }
};
function Ec(e) {
  const t = [], i = [], n = [];
  let r = e;
  const A = e - wi + 1 + es.length;
  for (let s = 0; s < A; s++) {
    const a = Math.pow(2, r);
    t.push(a);
    let l = 1 / a;
    s > e - wi ? l = es[s - e + wi - 1] : s === 0 && (l = 0), i.push(l);
    ...
    const D = new Ui();
    D.setAttribute("position", new jt(S, E)), D.setAttribute("uv", new jt(x, d)), D.setAttribute("faceIndex", new jt(P, f)), n.push(new Ft(D, null)), r > wi && r--;
  }
  return {
    lodMeshes: n,
    sizeLods: t,
...
var Ca = class extends Zt {
  constructor(e = 1, t = {}) {
    ...
    this.texture = new ga(n), this._setTextureOptions(t), this.texture.isRenderTargetTexture = !0;
  }
  fromEquirectangularTexture(e, t) {
    ...
    return t.minFilter === 1008 && (t.minFilter = St), new jl(1, 10, this).update(e, A), t.minFilter = s, A.geometry.dispose(), A.material.dispose(), this;
  }
  clear(e, t = !0, i = !0, n = !0) {
  ...
  function s(h) {
    if (h && h.isTexture) {
      ...
      if (w || E) {
        ...
        {
          const S = h.image;
          return w && S && S.height > 0 || E && S && l(S) ? (n === null && (n = new is(e)), d = w ? n.fromEquirectangular(h) : n.fromCubemap(h), d.texture.pmremVersion = h.pmremVersion, i.set(h, d), h.addEventListener("dispose", c), d.texture) : null;
        }
      }
    }
    return h;
...
function xc(e, t, i, n) {
  ...
  function o(u) {
    ...
    const d = new (w.count >= 65535 ? da : fa)(h, 1);
    d.version = E;
    const f = A.get(u);
...
function yc(e, t, i) {
  ...
  function A(s, a, l) {
    ...
    if (h === void 0 || h.count !== u) {
      ...
      const C = new Float32Array(P * D * 4 * u), B = new oa(C, P, D, u);
...
var ya = /* @__PURE__ */ new Qt(), aA = /* @__PURE__ */ new An(1, 1), Ta = /* @__PURE__ */ new oa(), Ba = /* @__PURE__ */ new ll(), ba = /* @__PURE__ */ new ga(), ss = [], as = [], os = new Float32Array(16), ls = new Float32Array(9), cs = new Float32Array(4);
function on(e, t, i) {
  const n = e[0];
  if (n <= 0 || n > 0) return e;
  const r = t * i;
...
function Yc(e, t, i) {
  ...
  let A;
  this.type === e.SAMPLER_2D_SHADOW ? (aA.compareFunction = i.isReversedDepthBuffer() ? 518 : 515, A = aA) : A = ya, i.setTexture2D(t || A, r);
}
function qc(e, t, i) {
  const n = this.cache, r = i.allocateTextureUnit();
...
function fh(e, t, i) {
  ...
  let s;
  this.type === e.SAMPLER_2D_SHADOW ? s = aA : s = ya;
...
var vh = class {
  constructor(e, t, i) {
    this.id = e, this.addr = i, this.cache = [], this.type = t.type, this.setValue = Zc(t.type);
  }
}, wh = class {
  constructor(e, t, i) {
    this.id = e, this.addr = i, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = gh(t.type);
  }
}, Eh = class {
  constructor(e) {
...
function Mh(e, t, i) {
  ...
  for (Zr.lastIndex = 0; ; ) {
    ...
    if (l && (a = a | 0), o === void 0 || o === "[" && s + 2 === r) {
      hs(i, o === void 0 ? new vh(a, e, t) : new wh(a, e, t));
      break;
    } else {
      let c = i.map[a];
      c === void 0 && (c = new Eh(a), hs(i, c)), i = c;
    }
  }
}
var lr = class {
  constructor(e, t) {
    ...
    for (let A = 0; A < i; ++A) {
      ...
      Mh(s, e.getUniformLocation(t, s.name), this);
    }
    const n = [], r = [];
...
function xh(e) {
  Ve._getMatrix(fs, Ve.workingColorSpace, e);
...
var Rh = /^[ \t]*#include +<([\w\d./]+)>/gm;
function oA(e) {
  return e.replace(Rh, Uh);
}
...
var Nh = /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;
function gs(e) {
  return e.replace(Nh, Fh);
}
function Fh(e, t, i, n) {
  let r = "";
...
function Oh(e) {
  return Qh[e.shadowMapType] || "SHADOWMAP_TYPE_BASIC";
}
var Vh = {
...
function zh(e) {
  return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : Vh[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
var Hh = { 302: "ENVMAP_MODE_REFRACTION" };
function kh(e) {
  return e.envMap === !1 ? "ENVMAP_MODE_REFLECTION" : Hh[e.envMapMode] || "ENVMAP_MODE_REFLECTION";
}
var Gh = {
...
function Wh(e) {
  return e.envMap === !1 ? "ENVMAP_BLENDING_NONE" : Gh[e.combine] || "ENVMAP_BLENDING_NONE";
}
function Xh(e) {
...
function Yh(e, t, i, n) {
  ...
  const l = Oh(i), o = zh(i), c = kh(i), u = Wh(i), h = Xh(i), p = Bh(i), w = bh(A), E = r.createProgram();
...
`), f = [
    ...
    i.toneMapping !== 0 ? yh("toneMapping", i.toneMapping) : "",
    i.dithering ? "#define DITHERING" : "",
    i.opaque ? "#define OPAQUE" : "",
    Le.colorspace_pars_fragment,
    Sh("linearToOutputTexel", i.outputColorSpace),
    Th(),
    i.useDepthPacking ? "#define DEPTH_PACKING " + i.depthPacking : "",
    `
`
  ].filter(Mn).join(`
`)), s = oA(s), s = ps(s, i), s = ms(s, i), a = oA(a), a = ps(a, i), a = ms(a, i), s = gs(s), a = gs(a), i.isRawShaderMaterial !== !0 && (S = `#version 300 es
`, d = [
    p,
    "#define attribute in",
    "#define varying out",
...
`) + `
` + f);
  const x = S + d + s, P = S + f + a, D = us(r, r.VERTEX_SHADER, x), C = us(r, r.FRAGMENT_SHADER, P);
    ...
    if (e.debug.checkShaderErrors) {
      ...
      if (r.getProgramParameter(E, r.LINK_STATUS) === !1)
        if (J = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(r, E, D, C);
          ...
          const te = ds(r, D, "vertex"), ce = ds(r, C, "fragment");
...
` + ce);
    ...
    r.deleteShader(D), r.deleteShader(C), g = new lr(r, E), _ = Ih(r, E);
  }
  let g;
  ...
  return this.isReady = function() {
    return W === !1 && (W = r.getProgramParameter(E, Ph)), W;
  }, this.destroy = function() {
    n.releaseStatesOfProgram(this), r.deleteProgram(E), this.program = void 0;
  }, this.type = i.shaderType, this.name = i.shaderName, this.id = _h++, this.cacheKey = t, this.usedTimes = 1, this.program = E, this.vertexShader = D, this.fragmentShader = C, this;
}
var qh = 0, Kh = class {
  constructor() {
...
function jh(e, t, i, n, r, A) {
  const s = new ha(), a = new Kh(), l = /* @__PURE__ */ new Set(), o = [], c = /* @__PURE__ */ new Map(), u = n.logarithmicDepthBuffer;
  let h = n.precision;
  const p = {
  ...
  function E(g, _, W, y, H, G) {
    ...
    const he = e.getRenderTarget(), xe = e.state.buffers.depth.getReversed(), Ce = H.isInstancedMesh === !0, Be = H.isBatchedMesh === !0, Xe = !!g.map, Oe = !!g.matcap, $e = !!J, pt = !!g.aoMap, xt = !!g.lightMap, Rt = !!g.bumpMap && g.wireframe === !1, et = !!g.normalMap, mt = !!g.displacementMap, ft = !!g.emissiveMap, lt = !!g.metalnessMap, I = !!g.roughnessMap, Lt = g.anisotropy > 0, Ye = g.clearcoat > 0, tt = g.dispersion > 0, M = g.iridescence > 0, m = g.sheen > 0, T = g.transmission > 0, z = Lt && !!g.anisotropyMap, K = Ye && !!g.clearcoatMap, ne = Ye && !!g.clearcoatNormalMap, ae = Ye && !!g.clearcoatRoughnessMap, R = M && !!g.iridescenceMap, ie = M && !!g.iridescenceThicknessMap, de = m && !!g.sheenColorMap, ve = m && !!g.sheenRoughnessMap, $ = !!g.specularMap, Me = !!g.specularColorMap, Pe = !!g.specularIntensityMap, be = T && !!g.transmissionMap, He = T && !!g.thicknessMap, b = !!g.gradientMap, q = !!g.alphaMap, Z = g.alphaTest > 0, fe = !!g.alphaHash, ge = !!g.extensions;
    let j = 0;
    ...
    const oe = {
      ...
      packedNormalMap: et && g.normalMapType === 0 && Zh(g.normalMap.format),
      metalnessMap: lt,
      roughnessMap: I,
      anisotropy: Lt,
      anisotropyMap: z,
  ...
  function x(g) {
    ...
    if (_) {
      const y = Jt[_];
      W = Pa.clone(y.uniforms);
    } else W = g.uniforms;
    return W;
  }
  function P(g, _) {
    let W = c.get(_);
    return W !== void 0 ? ++W.usedTimes : (W = new Yh(e, _, g, r), o.push(W), c.set(_, W)), W;
  }
  function D(g) {
    if (--g.usedTimes === 0) {
      const _ = o.indexOf(g);
...
function Es() {
  ...
  function c(h, p, w) {
    i.length > 1 && i.sort(h || eu), n.length > 1 && n.sort(p || ws), r.length > 1 && r.sort(p || ws), w && (i.reverse(), n.reverse(), r.reverse());
  }
  function u() {
...
function uu(e, t, i) {
  let n = new uA();
  const r = new Re(), A = new Re(), s = new At(), a = new Ul(), l = new Nl(), o = {}, c = i.maxTextureSize, u = {
    0: 1,
    1: 0,
    2: 2
  }, h = new bt({
    ...
    for (let k = 0, O = C.length; k < O; k++) {
      ...
      if (U.camera._reversedDepth = ee, U.map === null || G === !0) {
        if (U.map !== null && (U.map.depthTexture !== null && (U.map.depthTexture.dispose(), U.map.depthTexture = null), U.map.dispose()), this.type === 3) {
          ...
          X.isPointLight ? (U.map = new Ca(r.x), U.map.depthTexture = new Tl(r.x, bi)) : (U.map = new Zt(r.x, r.y), U.map.depthTexture = new An(r.x, r.y, bi)), U.map.depthTexture.name = X.name + ".shadowMap", U.map.depthTexture.format = Cn, this.type === 1 ? (U.map.depthTexture.compareFunction = ee ? 518 : 515, U.map.depthTexture.minFilter = St, U.map.depthTexture.magFilter = St) : (U.map.depthTexture.compareFunction = null, U.map.depthTexture.minFilter = Dt, U.map.depthTexture.magFilter = Dt);
      ...
      for (let ce = 0; ce < te; ce++) {
        ...
        if (X.isPointLight) {
          ...
          qe !== Ee.far && (Ee.far = qe, Ee.updateProjectionMatrix()), mn.setFromMatrixPosition(X.matrixWorld), Ee.position.copy(mn), jr.copy(Ee.position), jr.add(cu[ce]), Ee.up.copy(hu[ce]), Ee.lookAt(jr), Ee.updateMatrixWorld(), We.makeTranslation(-mn.x, -mn.y, -mn.z), Ps.multiplyMatrices(Ee.projectionMatrix, Ee.matrixWorldInverse), U._frustum.setFromProjectionMatrix(Ps, Ee.coordinateSystem, Ee.reversedDepth);
...
function fu(e, t) {
  ...
  function pt(b, q, Z, fe, ge, j, oe, Se, Et, Ze) {
    ...
    ge = ge || q, j = j || Z, oe = oe || fe, (q !== S || ge !== D) && (e.blendEquationSeparate(Oe[q], Oe[ge]), S = q, D = ge), (Z !== x || fe !== P || j !== C || oe !== B) && (e.blendFuncSeparate($e[Z], $e[fe], $e[j], $e[oe]), x = Z, P = fe, C = j, B = oe), (Se.equals(g) === !1 || Et !== _) && (e.blendColor(Se.r, Se.g, Se.b, Et), g.copy(Se), _ = Et), f = b, W = !1;
  }
  function xt(b, q) {
...
function du(e, t, i, n, r, A, s) {
  ...
  function xe(M, m, T) {
    ...
    if (ne.version !== ae.__version || K === !0) {
      ...
      if (m.isDepthTexture)
        ve = D(m.format === na, m.type), be && (Pe ? i.texStorage2D(e.TEXTURE_2D, 1, ve, R.width, R.height) : i.texImage2D(e.TEXTURE_2D, 0, ve, R.width, R.height, 0, ie, de, null));
...
void main() {
  ...
  constructor(e, t) {
    ...
    const w = typeof XRWebGLBinding < "u", E = new vu(), d = {}, f = t.getContextAttributes();
    let S = null, x = null;
    const P = [], D = [], C = new Re();
    let B = null;
    const g = new Wt();
    ...
    this.setFramebufferScaleFactor = function(Y) {
      ...
      if (n = Y, n !== null) {
        if (S = e.getRenderTarget(), n.addEventListener("select", k), n.addEventListener("selectstart", k), n.addEventListener("selectend", k), n.addEventListener("squeeze", k), n.addEventListener("squeezestart", k), n.addEventListener("squeezeend", k), n.addEventListener("end", O), n.addEventListener("inputsourceschange", X), f.xrCompatible !== !0 && await t.makeXRCompatible(), B = e.getPixelRatio(), e.getSize(C), w && "createProjectionLayer" in XRWebGLBinding.prototype) {
          ...
          f.depth && (he = f.stencil ? t.DEPTH24_STENCIL8 : t.DEPTH_COMPONENT24, re = f.stencil ? na : Cn, ue = f.stencil ? ia : bi);
          const xe = {
            colorFormat: t.RGBA8,
            depthFormat: he,
            scaleFactor: r
    ...
    function ee(Y, re, ue) {
      ...
      const he = U.distanceTo(J), xe = re.projectionMatrix.elements, Ce = ue.projectionMatrix.elements, Be = xe[14] / (xe[10] - 1), Xe = xe[14] / (xe[10] + 1), Oe = (xe[9] + 1) / xe[5], $e = (xe[9] - 1) / xe[5], pt = (xe[8] - 1) / xe[0], xt = (Ce[8] + 1) / Ce[0], Rt = Be * pt, et = Be * xt, mt = he / (-pt + xt), ft = mt * -pt;
      if (re.matrixWorld.decompose(Y.position, Y.quaternion, Y.scale), Y.translateX(ft), Y.translateZ(mt), Y.matrixWorld.compose(Y.position, Y.quaternion, Y.scale), Y.matrixWorldInverse.copy(Y.matrixWorld).invert(), xe[10] === -1)
        ...
        const lt = Be + mt, I = Xe + mt, Lt = Rt - ft, Ye = et + (he - ft), tt = Oe * Xe / I * lt, M = $e * Xe / I * lt;
        Y.projectionMatrix.makePerspective(Lt, Ye, tt, M, lt, I), Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert();
      }
    }
    function te(Y, re) {
...
}, Eu = /* @__PURE__ */ new at(), Ia = /* @__PURE__ */ new Ie();
...
function Mu(e, t) {
  ...
  function n(d, f) {
    f.color.getRGB(d.fogColor.value, Ma(e)), f.isFog ? (d.fogNear.value = f.near, d.fogFar.value = f.far) : f.isFogExp2 && (d.fogDensity.value = f.density);
  }
...
function Du() {
  return Kt === null && (Kt = new Dl(_u, 16, 16, cr, Ii), Kt.name = "DFG_LUT", Kt.minFilter = St, Kt.magFilter = St, Kt.wrapS = oi, Kt.wrapT = oi, Kt.generateMipmaps = !1, Kt.needsUpdate = !0), Kt;
}
var xu = class {
  constructor(e = {}) {
    const { canvas: t = Oo(), context: i = null, depth: n = !0, stencil: r = !1, alpha: A = !1, antialias: s = !1, premultipliedAlpha: a = !0, preserveDrawingBuffer: l = !1, powerPreference: o = "default", failIfMajorPerformanceCaveat: c = !1, reversedDepthBuffer: u = !1, outputBufferType: h = Mi } = e;
    ...
    function j() {
      Ye = new Dc(I), Ye.init(), Z = new pu(I, Ye), tt = new mc(I, Ye, e, Z), M = new fu(I, Ye), tt.reversedDepthBuffer && u && M.buffers.depth.setReversed(!0), H = I.createFramebuffer(), G = I.createFramebuffer(), k = I.createFramebuffer(), m = new Cc(I), T = new $h(), z = new du(I, Ye, M, T, tt, Z, m), K = new _c(_), ne = new hc(I), fe = new dc(I, ne), ae = new xc(I, ne, m, fe), R = new Tc(I, ae, ne, fe, m), He = new yc(I, tt, z), Me = new gc(T), ie = new jh(_, K, Ye, tt, fe, Me), de = new Mu(_, T), ve = new tu(), $ = new au(Ye), be = new fc(_, K, M, R, p, a), Pe = new uu(_, R, tt), ge = new Pu(I, m, tt, M), b = new pc(I, Ye, m), q = new Sc(I, Ye, m), m.programs = ie.programs, _.capabilities = tt, _.extensions = Ye, _.properties = T, _.renderLists = ve, _.shadowMap = Pe, _.state = M, _.info = m;
    }
    ...
    this.renderBufferDirect = function(v, L, V, F, N, Ae) {
      L === null && (L = mt);
      const le = N.isMesh && N.matrixWorld.determinantAffine() < 0, pe = Qa(v, L, V, F, N);
      M.setMaterial(F, le);
      let me = V.index, ye = 1;
      if (F.wireframe === !0) {
      ...
      if (me !== null && (nt = ne.get(me), ke = q, ke.setIndex(nt)), N.isMesh) F.wireframe === !0 ? (M.setLineWidth(F.wireframeLinewidth * lt()), ke.setMode(I.LINES)) : ke.setMode(I.TRIANGLES);
        ...
        let gt = F.linewidth;
        gt === void 0 && (gt = 1), M.setLineWidth(gt * lt()), N.isLineSegments ? ke.setMode(I.LINES) : N.isLineLoop ? ke.setMode(I.LINE_LOOP) : ke.setMode(I.LINE_STRIP);
      ...
      if (N.isBatchedMesh) if (Ye.get("WEBGL_multi_draw"))
        ...
        const gt = N._multiDrawStarts, we = N._multiDrawCounts, Ot = N._multiDrawCount, Ge = me ? ne.get(me).bytesPerElement : 1, Ut = T.get(F).currentProgram.getUniforms();
        for (let Yt = 0; Yt < Ot; Yt++)
          Ut.setValue(I, "_gl_DrawID", Yt), ke.render(gt[Yt] / Ge, we[Yt]);
      }
    ...
    const Pi = new xa();
    Pi.setAnimationLoop(Na), typeof self < "u" && Pi.setContext(self), this.setAnimationLoop = function(v) {
    ...
    function PA(v, L, V, F) {
      ...
      if (F.viewport !== void 0 && (F.viewport = void 0), D.setupLightsView(F), $e === !0 && Me.setGlobalState(_.clippingPlanes, F), Un(v, V, F), z.updateMultisampleRenderTarget(N), z.updateRenderTargetMipmap(N), Ye.has("WEBGL_multisampled_render_to_texture") === !1) {
        ...
        for (let _e = 0, je = L.length; _e < je; _e++) {
          const { object: it, geometry: nt, material: ke, group: gt } = L[_e];
          if (ke.side === 2 && it.layers.test(F.layers)) {
            const we = ke.side;
            ke.side = 1, ke.needsUpdate = !0, _A(it, V, F, nt, ke, gt), ke.side = we, ke.needsUpdate = !0, Fe = !0;
          }
        }
    ...
    function Qa(v, L, V, F, N) {
      ...
      if ((ui.position !== void 0 || ui.normal !== void 0 || ui.color !== void 0) && He.update(N, V, Ut), (hi || we.receiveShadow !== N.receiveShadow) && (we.receiveShadow = N.receiveShadow, Je.setValue(I, "receiveShadow", N.receiveShadow)), (F.isMeshStandardMaterial || F.isMeshLambertMaterial || F.isMeshPhongMaterial) && F.envMap === null && L.environment !== null && (st.envMapIntensity.value = L.environmentIntensity), st.dfgLUT !== void 0 && (st.dfgLUT.value = Du()), hi) {
        if (Je.setValue(I, "toneMappingExposure", _.toneMappingExposure), we.needsLights && Oa(st, Ni), Ae && F.fog === !0 && de.refreshFogUniforms(st, Ae), de.refreshMaterialUniforms(st, F, ue, re, D.state.transmissionRenderTarget[v.id]), we.needsLights && we.lightProbeGrid) {
    ...
    this.getActiveCubeFace = function() {
      ...
      const ke = Z.convert(L.format), gt = Z.convert(L.type);
      let we;
      ...
      const Ot = M.getParameter(I.UNPACK_ROW_LENGTH), Ge = M.getParameter(I.UNPACK_IMAGE_HEIGHT), Ut = M.getParameter(I.UNPACK_SKIP_PIXELS), Yt = M.getParameter(I.UNPACK_SKIP_ROWS), hi = M.getParameter(I.UNPACK_SKIP_IMAGES);
      ...
      if (v.isDepthTexture) {
        const st = T.get(v), ui = T.get(L), Ke = T.get(st.__renderTarget), ln = T.get(ui.__renderTarget);
        ...
        for (let Fi = 0; Fi < me; Fi++)
          Ni && (I.framebufferTextureLayer(I.READ_FRAMEBUFFER, I.COLOR_ATTACHMENT0, T.get(v).__webglTexture, N, Fe + Fi), I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER, I.COLOR_ATTACHMENT0, T.get(L).__webglTexture, Ae, it + Fi)), I.blitFramebuffer(ye, Ue, le, pe, _e, je, le, pe, I.DEPTH_BUFFER_BIT, I.NEAREST);
        ...
        M.bindFramebuffer(I.READ_FRAMEBUFFER, null), M.bindFramebuffer(I.DRAW_FRAMEBUFFER, null);
      } else Je ? v.isDataTexture || v.isData3DTexture ? I.texSubImage3D(we, Ae, _e, je, it, le, pe, me, ke, gt, nt.data) : L.isCompressedArrayTexture ? I.compressedTexSubImage3D(we, Ae, _e, je, it, le, pe, me, ke, nt.data) : I.texSubImage3D(we, Ae, _e, je, it, le, pe, me, ke, gt, nt) : v.isDataTexture ? I.texSubImage2D(I.TEXTURE_2D, Ae, _e, je, le, pe, ke, gt, nt.data) : v.isCompressedTexture ? I.compressedTexSubImage2D(I.TEXTURE_2D, Ae, _e, je, nt.width, nt.height, ke, nt.data) : I.texSubImage2D(I.TEXTURE_2D, Ae, _e, je, le, pe, ke, gt, nt);
      M.pixelStorei(I.UNPACK_ROW_LENGTH, Ot), M.pixelStorei(I.UNPACK_IMAGE_HEIGHT, Ge), M.pixelStorei(I.UNPACK_SKIP_PIXELS, Ut), M.pixelStorei(I.UNPACK_SKIP_ROWS, Yt), M.pixelStorei(I.UNPACK_SKIP_IMAGES, hi), Ae === 0 && L.generateMipmaps && I.generateMipmap(we), M.unbindTexture();
...
var zu = class {
  ...
  update(e, t = Bs(), i = 0) {
    ...
    if (this.lastProgress = n, this.lastUpdateTime = t, n <= $r && (this.liftArmed = !0), n < eA && (this.fullyDetached = !1, this.finishArmed = !0), Math.abs(s) < Uu) {
    ...
    if (s > 0 && w >= Ds) {
      if (this.stopVoices(/* @__PURE__ */ new Set(["reattach"]), 0.012), this.liftArmed && r <= xs && n >= xs && (this.playLift(E, d), this.liftArmed = !1), this.finishArmed && r < gn && n >= gn) {
      ...
      if (!this.fullyDetached) {
        ...
        for (; this.forwardTravel >= this.nextForwardSpacing && S < 2; ) {
          ...
          this.playTexture(E, x, d), this.forwardTravel -= this.nextForwardSpacing, this.nextForwardSpacing = f * Ts(), S += 1;
        }
        S === 2 && this.forwardTravel >= this.nextForwardSpacing && (this.forwardTravel = 0);
      }
      if (h <= tA && this.smoothedAcceleration > tA && E > 0.2 && t - this.lastAccentTime >= Nu && n < gn) {
    ...
    if (s < 0 && w >= Ds) {
      ...
      for (; this.backwardTravel >= this.nextBackwardSpacing && S < 1; )
        this.playReattach(E, d), this.backwardTravel -= this.nextBackwardSpacing, this.nextBackwardSpacing = f * Ts(), S += 1;
  ...
  preload() {
    ...
    bs(this.src, e).then((i) => {
      this.destroyed || t !== this.loadRevision || (this.buffer = i, this.profile = this.useBuiltInProfile ? Qu : Vu(i.duration), this.sliceBags = {
        micro: [],
        body: [],
        accent: []
      });
  ...
  preloadReappear() {
    const e = wn();
    !e || !this.enabled || this.destroyed || bs(Ru, e).then((t) => {
  ...
  playTexture(e, t, i) {
    ...
    this.playSlice(r, {
      ...
      gain: (0.07 + 0.2 * e ** 0.65) * t * ys(ai(-1.5, 1.5)),
      lowpass: 2400 + e * 9e3,
      highpass: 210,
      attack: 6e-3 - e * 35e-4,
  ...
  playReattach(e, t) {
    ...
    i && this.playSlice(i, {
      ...
      gain: (0.024 + 0.052 * e ** 0.7) * ys(ai(-1.2, 1.2)),
      lowpass: 1500 + e * 2400,
      highpass: 120,
      attack: 5e-3,
      release: 0.02,
  ...
  takeSlice(e) {
    ...
    i.length || (i = Ou(t.length), i.length > 1 && t[i[i.length - 1]]?.key === this.lastSliceKey && ([i[0], i[i.length - 1]] = [i[i.length - 1], i[0]]), this.sliceBags[e] = i);
...
async function qu(e) {
  ...
  if (n?.length) {
    ...
    const g = _t(Math.ceil(D.contentWidth + S * 2), Ei, Bi), _ = _t(Math.ceil(D.contentHeight + S * 2), Ei, Bi), W = document.createElement("canvas");
  ...
  const c = l.actualBoundingBoxAscent || Math.max(A * 0.76, 1), u = l.actualBoundingBoxDescent || Math.max(A * 0.2, 1), h = 144, p = _t(Math.ceil(l.width + h * 2), Ei, Bi), w = _t(Math.ceil(c + u + h * 2), Ei, 1280), E = document.createElement("canvas");
...
async function Ku(e) {
  const t = Wu(e.svg), i = Xu(t), n = 1740, r = 144, A = i >= 1 ? n : n * i, s = i >= 1 ? n / i : n, a = _t(Math.ceil(A + r * 2), Ei, Bi), l = _t(Math.ceil(s + r * 2), Ei, Bi), o = document.createElement("canvas");
...
async function Ju(e) {
  const t = await Ra(e.src), i = La(t), n = _t(t.naturalWidth / t.naturalHeight, 0.15, 8), r = 1740, A = 144, s = n >= 1 ? r : r * n, a = n >= 1 ? r / n : r, l = _t(Math.ceil(s + A * 2), Ei, Bi), o = _t(Math.ceil(a + A * 2), Ei, Bi), c = document.createElement("canvas");
...
function $u(e, t) {
  ...
  for (let d = 0; d < s; d += 1) {
    const f = o ? _t(t + 0.5 - Math.sqrt(a[d]), 0, 1) : 0, S = d * 4;
...
async function Us(e, t) {
  ...
  return {
    ...
    alpha: a,
    exteriorAlpha: Gu(a, r.width, r.height),
...
}, Fs = 2.55, rf = Math.PI, Af = 1.28, Qs = 4e-3, Os = -0.22, sf = 0.035, af = 0.74, of = 760, lf = 520, Ef = 720, Vs = 720 / 1e3, zs = 0.06, cf = 0.42, hf = 0.32, uf = 0.9, ff = "rgb(36, 126, 245)";
function Ne(e, t, i) {
  return Math.min(i, Math.max(t, e));
}
function iA(e, t, i) {
...
var df = class {
  constructor(e, t = {}) {
    this.camera = new gr(-1, 1, 1, -1, 0.01, 10), this.scene = new gl(), this.peelAudio = new zu(), this.groundShadowGeometry = new xn(1, 1), this.peelShadowLight = new Zl(16777215, 1), this.peelShadowTarget = new It(), this.geometry = new xn(1, 1, 2, 2), this.texture = null, this.artwork = null, this.source = Ti, this.requestedSource = Ti, this.sourceRevision = 0, this.sourceRebuildTimer = null, this.destroyed = !1, this.resizeObserver = null, this.viewWidth = 2, this.viewHeight = 2, this.viewportHeightPx = 420, this.renderScale = 1, this.meshWidth = 1.6, this.meshHeight = 0.62, this.pointerId = null, this.grabOrigin = new Re(-0.8, 0), this.grabStart = new Re(), this.grabDirection = new Re(1, 0), this.activeDirection = new Re(1, 0), this.grabExtent = 1.6, this.creaseDepth = 0, this.basePeelRadius = 0.08, this.effectivePeelRadius = 0.08, this.grabProjection = 0, this.springVelocity = 0, this.springActive = !1, this.springTargetDepth = 0, this.dragDetached = !1, this.detachedTension = 0, this.detachedExitActive = !1, this.detachedExitElapsed = 0, this.detachedExitSpin = 0, this.entranceActive = !1, this.entranceElapsed = 0, this.preparedEntrance = null, this.backgroundRemovalEffectActive = !1, this.backgroundRemovalEffectElapsed = 0, this.interactionHintActive = !1, this.interactionHintElapsed = 0, this.entranceAxis = new Re(1, 0), this.frameRequest = 0, this.lastFrameTime = 0, this.state = {
      ...
      if (this.dragDetached) {
        const c = a > Qs ? s.clone().normalize() : this.grabDirection;
        c.dot(this.grabDirection) >= Os && (this.activeDirection.copy(c), this.grabExtent = this.projectionExtent(this.grabOrigin, this.activeDirection), a < this.peelModelForDepth(this.grabExtent).projection && (this.dragDetached = !1));
      }
      if (this.dragDetached) {
        ...
        if (a > Qs) {
          ...
          c.dot(this.grabDirection) >= Os ? (this.activeDirection.copy(c), l = a) : o = !0;
        ...
        if (this.grabExtent = this.projectionExtent(this.grabOrigin, this.activeDirection), o)
          ...
          this.creaseDepth - u > this.grabExtent * sf || this.springActive && u < this.creaseDepth ? (this.springActive || (this.springActive = !0, this.springVelocity = 0), this.springTargetDepth = u) : (this.springActive = !1, this.springVelocity = 0, this.springTargetDepth = u, this.setCreaseDepth(u));
      ...
      if (this.preparedEntrance) {
        ...
        const l = Ne(this.preparedEntrance.elapsed / hf, 0, 1), o = iA(0, 1, l);
      ...
      if (this.entranceActive && (this.entranceElapsed += A, this.applyEntranceElapsed(this.entranceElapsed) && (this.entranceActive = !1, this.clearEntrancePose(), this.emit("cyclecomplete", { progress: 0 }))), this.interactionHintActive) {
        ...
        const l = Ne(this.interactionHintElapsed / uf, 0, 1);
    ...
    }, this.container = e, this.options = En(void 0, t), this.camera.position.z = 3, this.renderer = new xu({
      alpha: !0,
      antialias: !0,
      ...
      uBackColor: { value: Gt(this.options.back.color, "#f7f5f2") },
      ...
      uMaterialTint: { value: Gt(this.options.material.tint, "#d8dde7") },
      uMaterialSecondaryTint: { value: Gt(this.options.material.secondaryTint, "#f2b7ff") },
      uMaterialSeed: { value: this.options.material.seed },
      uShadowColor: { value: Gt(this.options.shadow.color, "#191823") },
      ...
      uInteractionHintColor: { value: Gt(ff, "rgb(36, 126, 245)") },
  ...
  updateMeshGeometry(e) {
    const t = this.viewHeight / Math.max(1, this.viewportHeightPx), i = Math.min(this.viewWidth * 0.78, of * t), n = Math.min(this.viewHeight * 0.58, lf * t);
    let r = i, A = r / e;
    A > n && (A = n, r = A * e), this.meshWidth = Math.max(0.34, r), this.meshHeight = Math.max(0.25, A);
    const s = this.options.quality === "high" ? 240 : this.options.quality === "medium" ? 160 : 96, a = Ne(Math.round(s), 64, 256), l = Ne(Math.round(s / Math.max(e, 0.35)), 56, 192), o = new xn(this.meshWidth, this.meshHeight, a, l), c = this.geometry;
  ...
  applyOptionsToRenderer() {
    ...
    const s = this.options.peel.maxAngle, a = s > Math.PI * 2 ? Vt.degToRad(s) : s;
    this.uniforms.uMaxAngle.value = Ne(a, Fs, rf);
    ...
    this.basePeelRadius = c * Vt.lerp(0.82, 1.16, Ne(this.options.peel.stiffness, 0, 1)), this.setCreaseDepth(this.creaseDepth), this.uniforms.uShadowColor.value = Gt(this.options.shadow.color, "#191823");
    const u = (0.45 + i * 0.75) * (1 - n * 0.35), h = Ne(this.options.shadow.opacity * u, 0, 0.9);
    this.uniforms.uShadowOpacity.value = h, this.groundShadowMaterial.color.copy(Gt(this.options.shadow.color, "#191823")), this.groundShadowMaterial.opacity = h;
    ...
    if (d.set(-t.x, -t.y), d.lengthSq() < 1e-4) {
      const x = Vt.degToRad(this.options.shadow.angle);
      d.set(Math.cos(x), -Math.sin(x));
    }
    d.normalize();
    const f = 1.6 + this.uniforms.uShadowDistance.value * 34;
    this.peelShadowLight.position.set(t.x * f, t.y * f, Math.max(0.8, t.z * f)), this.peelShadowTarget.position.set(0, 0, 0), this.peelShadowLight.shadow.radius = Vt.lerp(1, 7, r);
  ...
  setDetachedDragOffset(e, t) {
    const i = Vt.degToRad(this.options.tilt), n = Math.cos(i), r = Math.sin(i), A = Ne(Math.hypot(e, t) / Math.max(this.grabExtent * 0.45, 0.12), 0, 1);
  ...
  finishPointerDrag(e) {
    ...
    const i = this.options.peel.release, n = this.springActive ? Math.min(this.state.progress, Ne(this.springTargetDepth / Math.max(this.grabExtent, 1e-3), 0, 1)) : this.state.progress, r = i === "snap" && n >= af;
  ...
  applyEntranceElapsed(e) {
    ...
    const i = Ne((e - zs) / cf, 0, 1);
    return this.uniforms.uEntranceSweep.value = e < zs ? -1 : i, t >= 1 && i >= 1;
  }
  clearEntrancePose() {
...
var mf = typeof HTMLElement > "u" ? class {
} : HTMLElement, ks = class extends mf {
  constructor(...e) {
  ...
  setOptions(e) {
    this.pendingOptions = Hs(this.pendingOptions, e), this.instance?.setOptions(e);
  }
  reset() {
    this.instance?.reset();
  }
  ...
  ensureInstance() {
    ...
    const e = Hs(this.pendingOptions, { source: this.pendingSource ?? Ti }), t = this.lifecycleRevision, i = pf(this.mountElement, e);
...
function gf(e = "sticker-forge") {
  if (!(typeof customElements > "u") && !customElements.get(e)) {
    const t = e === "sticker-forge" ? ks : class extends ks {
    };
...
gf();
export {
  Ef as STICKER_ENTRANCE_DURATION_MS,
  ks as StickerForgeElement,
  pf as createSticker,
  gf as defineStickerForge,
  wf as imageSourceHasTransparency,
